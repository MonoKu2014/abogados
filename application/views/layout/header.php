...
<html>
<head>
	<title>Panel Abogado en Línea</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <li <?= active('notarias')?>>
                    <a href="<?= base_url(); ?>notarias">
                        <i class="fa fa-fw fa-bank"></i> Notarias
                    </a>
                </li>
                ...
                <li <?= active('documentos')?>>
                    <a href="<?= base_url(); ?>documentos">
                        <i class="fa fa-fw fa-file-word-o"></i> Documentos
                    </a>
                </li>

                <li <?= active('historial')?>>
                    <a href="<?= base_url(); ?>historial">
                        <i class="fa fa-fw fa-comments"></i> Historial Chat
                    </a>
                </li>
